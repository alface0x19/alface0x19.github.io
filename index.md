...
<div class="index-layout">
  ...
  <div class="hero-card">
    <div class="hero-bar">
      <span class="hero-bar__dots"><i></i><i></i><i></i></span>
      <span class="hero-bar__label">alface0x19@github.io:~$</span>
    </div>
    <div class="hero-body">
      <img src="{{ site.baseurl }}/assets/images/index/icon.png" alt="alface0x19" class="index-logo">
      <div class="hero-text">
        <div class="hero-meta">// tech blogger · linux · devops · security</div>
        <h2 class="hero-title">alface0x19<span class="hero-cursor">_</span></h2>
